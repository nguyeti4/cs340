...
@app.route("/simulators/update/<select_date>")
def sim_update(select_date):
    db_connection = connect_to_database()
    ...
    return render_template('simulators.html', delete_dates=dates_to_delete, select_date=oldest_date)
    print(oldest_date)
